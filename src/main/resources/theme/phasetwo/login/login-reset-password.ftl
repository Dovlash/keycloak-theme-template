    ...
    <#elseif section = "form">
        ...
        <div class="kc-form-body">
          ...
          <div class="${properties.kcFormGroupClass!}">
              ...
              <div id="kc-form-options" class="kc-form-options-pass ${properties.kcFormOptionsClass!}">
        ...
        <div class="kc-form-foot ${properties.kcFormGroupClass!} ${properties.kcFormSettingClass!}">
